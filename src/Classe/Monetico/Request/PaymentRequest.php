...
use App\Classe\Monetico\Request\CofidisPaymentInformations;
...
class PaymentRequest
{
    ...
    public function getFormFields()
    {
        ...
        $seal = $hmacComputer->sealFields($formFields, MoneticoConfig::CLE_MAC);
        $formFields['MAC'] = $seal;
        return $formFields;
    }
    ...
    public function getFormFieldsWithoutMac()
    {
        $formFields = [];
        // Payment terminal
        $formFields["TPE"] = MoneticoConfig::TPE;
        $formFields["societe"] = MoneticoConfig::CODE_SOCIETE;
     ...
     * @return OrderContext
     */
    public function getContexteCommande(): OrderContext
    {
        return $this->contexteCommande;
    }

    /**
     * @param OrderContext $contexteCommande
     */
    public function setContexteCommande(OrderContext $contexteCommande): void
    {
    ...
    /**
     * @return CofidisPaymentInformations|null
     */
    public function getCofidis(): ?CofidisPaymentInformations
    {
        return $this->cofidis;
    }

    /**
     * @param CofidisPaymentInformations|null $cofidis
     */
    public function setCofidis(?CofidisPaymentInformations $cofidis): void
    {
