 ...
 */
final class Version20220320113654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reporting (id INT AUTO_INCREMENT NOT NULL, investor_id_id INT DEFAULT NULL, created_at DATETIME DEFAULT NULL, reporting_name VARCHAR(255) DEFAULT NULL, INDEX IDX_BD7CFA9F6B62CD11 (investor_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reporting_details DROP FOREIGN KEY FK_A477282227EE0E60');
