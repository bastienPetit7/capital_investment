 ...
 */
final class Version20220518165929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE capital_investment_asset (id INT AUTO_INCREMENT NOT NULL, total_asset BIGINT DEFAULT NULL, recovery_found_total BIGINT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE position (id INT AUTO_INCREMENT NOT NULL, position_type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, active_left VARCHAR(255) NOT NULL, active_right VARCHAR(255) DEFAULT NULL, action VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, tp1 DOUBLE PRECISION DEFAULT NULL, tp2 DOUBLE PRECISION DEFAULT NULL, tp3 DOUBLE PRECISION DEFAULT NULL, tp4 DOUBLE PRECISION DEFAULT NULL, stop_loss DOUBLE PRECISION DEFAULT NULL, published_at DATE NOT NULL, price DOUBLE PRECISION DEFAULT NULL, week_of_creation VARCHAR(255) DEFAULT NULL, position_state VARCHAR(255) DEFAULT NULL, INDEX IDX_462CE4F556BD9D60 (position_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE subscription (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, sub_title VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, is_active TINYINT(1) DEFAULT NULL, is_main TINYINT(1) DEFAULT NULL, image_path VARCHAR(255) DEFAULT NULL, short_description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE wallet (id INT AUTO_INCREMENT NOT NULL, investor_id INT NOT NULL, origin_initial_amount INT DEFAULT NULL, initial_amount INT DEFAULT NULL, actual_amount INT DEFAULT NULL, name VARCHAR(255) NOT NULL, status VARCHAR(255) DEFAULT NULL, interest_rates DOUBLE PRECISION DEFAULT NULL, interest_type VARCHAR(255) DEFAULT NULL, currency VARCHAR(255) DEFAULT NULL, interest_recovery_found INT DEFAULT NULL, total_actif INT DEFAULT NULL, INDEX IDX_7C68921F9AE528DA (investor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE widget (id INT AUTO_INCREMENT NOT NULL, widget_theme_id INT NOT NULL, name VARCHAR(255) NOT NULL, bg_color VARCHAR(255) NOT NULL, is_published TINYINT(1) NOT NULL, INDEX IDX_85F91ED0B56FA9A6 (widget_theme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE widget_line (id INT AUTO_INCREMENT NOT NULL, widget_id INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_49E3BF49FBE885E2 (widget_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bonus DROP FOREIGN KEY FK_9F987F7A5C5AA200');
        ...
        $this->addSql('ALTER TABLE widget_content_line DROP FOREIGN KEY FK_F8468CB229F5F9D6');
        $this->addSql('ALTER TABLE widget_content_line DROP FOREIGN KEY FK_F8468CB243547283');
