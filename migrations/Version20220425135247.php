 ...
 */
final class Version20220425135247 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE position (id INT AUTO_INCREMENT NOT NULL, position_type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, active_left VARCHAR(255) NOT NULL, active_right VARCHAR(255) DEFAULT NULL, action VARCHAR(255) NOT NULL, tp1 DOUBLE PRECISION DEFAULT NULL, tp2 DOUBLE PRECISION DEFAULT NULL, tp3 DOUBLE PRECISION DEFAULT NULL, tp4 DOUBLE PRECISION DEFAULT NULL, stop_loss DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, published_at DATETIME NOT NULL, price DOUBLE PRECISION DEFAULT NULL, week_of_creation VARCHAR(255) DEFAULT NULL, INDEX IDX_462CE4F556BD9D60 (position_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
